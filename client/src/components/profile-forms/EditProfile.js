...
import { Link, withRouter } from 'react-router-dom'; //NOTE withRouter will allow us to redirect from the action (history.push)
...
const EditProfile = ({ 
    ...
    useEffect( () => {
        getCurrentProfile(); //NOTE get profile base on token and grab it into state redux(store)
        setFormData({
